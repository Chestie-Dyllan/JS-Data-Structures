...
var toast = new stockItems(1, "Farmhouse Breakfast", 62.00);
var eng_breakfast = new stockItems(2, "English Breakfast", 62.59);
var omelette = new stockItems(3, "3 Egg Omelette", 80.00);
var muffin = new stockItems(4, "Breakfast Bagel", 25.50);
var croissant = new stockItems(5, "Egg & Bacon Toasties", 25.00);
var combo_tram = new stockItems(6, "Yoghurt and fruit bowl", 38.00);
var chicken_tram = new stockItems(7, "Muffin of the day", 20.00);
var cheese_burger = new stockItems(8, "Breakfast Burger", 68.00);
var bacon_cheese_burger = new stockItems(9, "Dagwood", 58.50);
var mex_pizza = new stockItems(10, "Cheese burger", 32.00);
...
var user_1 = new client("Clark Kent", 3322);
var user_2 = new client("Barry Allen", 1234);
var user_3 = new client("Bruce Wayne", 8475);
...
//function to remove objects from the cart[] array
...
function display_all() {
    ...
    var myCart = "<br/>  CART  <br/>";
    var emptyCart = "<br>  Empty <br>"
    if (cart.length == 0) {
        myCart += emptyCart;
    }
    for (var i in cart) {
